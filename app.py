...
/* Soft healthcare background decoration */
.stApp::before {
    content: "";
    position: fixed;
    width: 430px;
...
section[data-testid="stSidebar"] {
    ...
    border-right: 1px solid #0B467D !important;
    min-width: 290px !important;
    width: 290px !important;
    transform: none !important;
}
section[data-testid="stSidebar"] > div {
    background: linear-gradient(180deg, #082B52 0%, #0B3968 100%) !important;
}
section[data-testid="stSidebar"] .block-container {
    padding: 1.15rem 1rem 1.2rem !important;
}
/* Remove Streamlit's sidebar collapse controls so the navigation stays visible. */
...
.brand-ai { color: #55B8FF !important; }
.brand-sub {
...
.topbar-title { color: #244B70 !important; font-size:14px; font-weight:850; }
.user-chip {
    display:flex;
    align-items:center;
    gap:9px;
    ...
    font-size:12px;
    font-weight:800;
    box-shadow:0 6px 18px rgba(8,43,82,.08);
}
.avatar {
    width:28px; height:28px; border-radius:50%;
    display:flex; align-items:center; justify-content:center;
    background:#D9F1FF; color:var(--blue) !important;
}

/* ================= WHITE CARDS ON SKY BACKGROUND ================= */
.card, .metric, .section-card, .feature-panel, .welcome-card, .hero {
    background:#FFFFFF !important;
    border:1px solid #B8D9EC !important;
    box-shadow:0 12px 32px rgba(20,76,112,.10) !important;
}
.card { border-radius:18px; padding:21px; margin-bottom:15px; }
.card-title { font-size:17px; font-weight:900; color:var(--text) !important; margin-bottom:4px; }
.card-sub { font-size:12px; color:var(--muted) !important; margin-bottom:14px; }
.metric { border-radius:16px; padding:17px; }
.metric .label { font-size:10px; font-weight:900; color:#55758F !important; text-transform:uppercase; letter-spacing:.10em; }
.metric .value { color:var(--text) !important; font-size:23px; font-weight:900; margin-top:5px; }
.section-card { border-radius:14px; padding:14px 16px; margin:8px 0; }
.section-title { color:var(--text) !important; font-size:13px; font-weight:900; }
.section-help { color:var(--muted) !important; font-size:11px; margin-top:3px; }
...
.hero {
    ...
    margin-bottom:18px;
    min-height:260px;
    background:linear-gradient(115deg, #FFFFFF 0%, #F8FDFF 58%, #EAF7FF 100%) !important;
}
.hero:before {
    content:"";
    position:absolute;
...
.eyebrow { color:var(--blue) !important; font-size:10px; font-weight:950; letter-spacing:.13em; text-transform:uppercase; }
.hero h1 { font-size:44px; margin:7px 0 8px; color:#0B2F55 !important; position:relative; z-index:2; font-weight:950 !important; }
.hero p { font-size:15px; max-width:720px; margin:0; color:#46677F !important; line-height:1.65; position:relative; z-index:2; }
.hero-badges { margin-top:17px; display:flex; gap:7px; flex-wrap:wrap; position:relative; z-index:2; }
.badge { display:inline-block; padding:6px 10px; border-radius:999px; background:#E4F5FF !important; color:#0D5DA8 !important; font-size:10px; font-weight:900; border:1px solid #B9E1F5; }

/* ================= LOGIN ================= */
.welcome-card { border-radius:22px; padding:38px 34px; text-align:center; }
.welcome-icon {
    width:70px; height:70px; border-radius:20px; margin:0 auto 17px;
    display:flex; align-items:center; justify-content:center;
    font-size:34px; color:#FFFFFF !important; background:#1769E0 !important;
    box-shadow:0 12px 26px rgba(23,105,224,.25);
}
.welcome-card h1 { font-size:38px; margin:0; color:#0B2F55 !important; font-weight:950 !important; }
.welcome-card h1 span { color:#1769E0 !important; }
.welcome-card .lead { color:#52718A !important; font-size:15px; margin:8px 0 24px; }
.feature-panel { border-radius:22px; padding:20px; }
.feature-photo {
    height:175px; border-radius:17px; margin-bottom:16px;
    background:linear-gradient(135deg,#D9F3FF,#EDF9FF);
    display:flex; align-items:center; justify-content:center;
    font-size:68px;
}
.feature-item { display:flex; gap:12px; padding:11px 3px; }
.feature-dot { width:38px; height:38px; border-radius:11px; display:flex; align-items:center; justify-content:center; background:#E2F5FF; font-size:18px; flex:0 0 auto; }
.feature-item b { color:#183D61 !important; font-size:12px; }
.feature-item span { display:block; color:#66839A !important; font-size:10px; margin-top:3px; line-height:1.45; }
.security-box { margin-top:17px; padding:12px 14px; border-radius:13px; background:#EFF9FF; border:1px solid #C6E4F3; color:#496A82 !important; font-size:10px; text-align:left; }

/* ================= ALERTS ================= */
.notice { padding:14px 16px; border-radius:13px; background:#EDF9FF; border:1px solid #BFE1F2; color:#315C77 !important; font-size:12px; line-height:1.55; }
.warning { padding:14px 16px; border-radius:13px; background:#FFF9EA; border:1px solid #F0E0B7; color:#725C28 !important; font-size:12px; line-height:1.55; }
.success-box { padding:14px 16px; border-radius:13px; background:#EFFAF6; border:1px solid #CBEBDD; color:#276A59 !important; font-size:12px; }
...
.stButton > button:hover { border-color:#1769E0 !important; color:#0D4FAF !important; }
...
.stTextInput label, .stTextArea label, .stSelectbox label, .stFileUploader label { color:#234A69 !important; font-weight:800 !important; }
.stFileUploader section { background:#F8FDFF !important; border:1.5px dashed #83B9D7 !important; border-radius:15px !important; }
.stFileUploader section:hover { border-color:#1769E0 !important; background:#EFF9FF !important; }
.stRadio label, .stCheckbox label { color:#294D69 !important; }

/* Keep Streamlit's native sidebar text high contrast. */
section[data-testid="stSidebar"] * { color:inherit; }
section[data-testid="stSidebar"] .stMarkdown p { color:#D9ECFA !important; }
section[data-testid="stSidebar"] .stCaption p { color:#9EC6E5 !important; }
    ...
    with center:
        st.markdown(
            ...
            <div class="welcome-card">
                ...
                <h1 style="color:#102A56 !important;">CareNote <span style="color:#2F66F6 !important;">AI</span></h1>
...
if page == "🏠 Home":
    st.markdown(
        f"""
        <div class="hero">
            <div class="eyebrow">CAReNOTE AI · HEALTHCARE DOCUMENTATION</div>
