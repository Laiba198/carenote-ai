...
st.markdown(
    ...
    * { box-sizing: border-box; }
    ...
    section[data-testid="stSidebar"] div[role="radiogroup"] label[data-checked="true"] {
        ...
        box-shadow: 0 7px 18px rgba(47,102,246,.24);
    }
    ...
    .user-chip {
        ...
        font-size: 12px;
        font-weight: 750;
        box-shadow: 0 4px 14px rgba(20,52,94,.05);
    }
    ...
    .hero {
        ...
        box-shadow: 0 8px 28px rgba(28,58,100,.06) !important;
    }
    ...
    .welcome-icon {
        ...
        color: #FFFFFF !important;
        background: var(--blue) !important;
        box-shadow: 0 12px 26px rgba(47,102,246,.20);
    }
    ...
    .stButton > button[kind="primary"] {
        ...
        border: 0 !important;
        color: #FFFFFF !important;
        box-shadow: 0 7px 17px rgba(47,102,246,.20);
    }

    .stButton > button[kind="primary"]:hover {
        background: #2457DE !important;
    }
